...
def MaxPriceLastDay(df):
    ...
    """
    Returns the maximum price for the last day in a price series.

    Args:
    df (pandas.DataFrame): A pandas DataFrame of prices.

    Returns:
    float: The maximum price for the last day in the price series.
    """
...
def MinPriceLastDay(df):
    ...
    """
    Returns the minimum price for the last day in a price series.

    Args:
    df (pandas.DataFrame): A pandas DataFrame of prices.

    Returns:
    float: The minimum price for the last day.
    """
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        dash_table.DataTable(
            id='BTC_daily_values',
            columns=[{"name": i, "id": i} for i in ["Open", "Close", "Min (24h)", "Average", "Max (24h)", "Lowest", "Highest"]],
            data=[{"Open": open, "Close": close, "Min (24h)": min_price, "Average": avg_price, "Max (24h)": max_price, "Lowest": lowest, "Highest": highest}], 
